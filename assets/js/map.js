mapboxgl.accessToken = 'pk.eyJ1IjoicGF2bGV4IiwiYSI6ImNqdDFzZ21jMjFicnUzeXBpdWdhN2kxcWsifQ.zKtSyBPurpgdRpVR1HK7mQ';

var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/light-v9',
    center: [22.7909, 40.3691],
    zoom: 10,
...
document.getElementById('GreeceBookmark').addEventListener('click', function () {
...
document.getElementById('ThermaikosBookmark').addEventListener('click', function () {
...
document.getElementById('WorldBookmark').addEventListener('click', function () {
